...
export default function BiharElectionNews({
    heading,
    mainImage,
    mainHeadline,
    newsCards,
    mainNewsList, // Array of strings for the red box section
    sideNews,
    buttonText,
    onViewMore,
}) {
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    <div className="lg:col-span-8 flex flex-col">
                        <div className="flex flex-row gap-4 mb-6">
                            ...
                            {/* Red box: vertical news headlines */}
